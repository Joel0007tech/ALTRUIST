...
const Contact = () => {
  ...
  return (
    <div>
        ...
        <div className='flex flex-col' data-aos="fade-down" data-aos-delay="50" data-aos-duration="1000">
        ...
        <form className="flex flex-col pt-3 gap-2" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
