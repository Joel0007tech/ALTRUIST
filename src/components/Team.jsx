    ...
    <div>
        <div>
          ...
          <div className='flex justify-center gap-3 sm:flex sm:flex-col'>
           <div className='flex flex-col bg-blue-500 p-16 sm:rounded-md sm:w-[350px] sm:m-auto'>
           ...
           <div className='flex flex-col bg-blue-500 pt-16 sm:pb-16 sm:rounded-md sm:w-[350px] sm:m-auto'>
